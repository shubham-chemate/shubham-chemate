...
- In my free time I build applications or I would say tech solutions to problems that I encounter [my recent weekend project](https://github.com/shubham-chemate/ai-bill-splitter) or just experiment with cool techs (my recent favorite is [Temporal](https://github.com/temporalio/temporal)).  
